    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        friendsListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                int idNew = (int) friendIdList.get(position);
                db.close();

                Intent i = new Intent(FriendsActivity.this, FriendDetailActivity.class);
                i.putExtra("id", idNew);
                startActivity(i);
            }
        });
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (id) {
            case R.id.action_add:
                Intent i0 = new Intent(FriendsActivity.this, FriendAddActivity.class);
                startActivity(i0);
                return true;
            case R.id.action_home:
                Intent i1 = new Intent(FriendsActivity.this, HomeActivity.class);
                startActivity(i1);
                return true;
    ...
    public boolean onContextItemSelected(MenuItem item) {
        ...
        switch (id) {
            case 0:
                ...
                int idNew = (int) friendIdList.get(pos);
                db.close();
                Intent i0 = new Intent(FriendsActivity.this, FriendUpdateActivity.class);
                        ...
                        .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                            public void onClick(final DialogInterface d, final int i) {
                                ...
                                if (db.deleteFriend((Integer) friendIdList.get(pos))) {
                                    Toast.makeText(FriendsActivity.this, "Friend has been deleted", Toast.LENGTH_LONG).show();
                                } else {
